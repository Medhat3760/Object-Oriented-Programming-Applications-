...
namespace Bank_System
{
    ...
    public class clsBankClient : clsPerson
    {
        ...
        private static stTransferLogRecord _ConvertTransferLogLineToRecord(string line, string separator = "#//#")
        {
            ...
            transferLogRecord.sourceBalanceAfter = double.Parse(lTransferLogData[4]);
            transferLogRecord.destinationBalanceAfter = double.Parse(lTransferLogData[5]);
        ...
        */
        ...
        public struct stTransferLogRecord
        {
            ...
            public double sourceBalanceAfter;
            public double destinationBalanceAfter;
            public string userName;

        }

        public static List<stTransferLogRecord> GetTransferLogList()
        {
            ...
            if (File.Exists("TransferLog.txt"))
            {
                ...
                using (StreamReader myFile = new StreamReader("TransferLog.txt"))
                {
                    ...
                    while ((line = myFile.ReadLine()) != null)
                    {
                        ...
                        stTransferLogRecord transferLogRecord = _ConvertTransferLogLineToRecord(line);

                        listTransferLogRecord.Add(transferLogRecord);
