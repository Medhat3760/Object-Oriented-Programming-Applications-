...
namespace Bank_System.Screens.Client
{
    public class clsTransferLogScreen : clsScreen
    {
        ...
        private static void _PrintTransferLogRecordLine(clsBankClient.stTransferLogRecord transferLogRecord)
        {
            ...
            Console.Write($"| {transferLogRecord.srcBalanceAfter.ToString().PadRight(12)}");
            Console.Write($"| {transferLogRecord.destBalanceAfter.ToString().PadRight(12)}");
        ...
        public static void ShowTransferLogScreen()
        {
            ...
            List<clsBankClient.stTransferLogRecord> listTransferLogRecord = clsBankClient.GetTransfersLogList();
