...
namespace Bank_System.Core
{
    public class clsCurrency
    {
        ...
        public double ConvertToAnotherCurrency(double amount, clsCurrency targetCurrency)
        {
        ...
        /*
         ...
         public static double convert_currency_to_another(clsCurrency C1, clsCurrency C2, double amount)
         {
