...
namespace Bank_System
{
    public class clsMainScreen : clsScreen
    {
        ...
        private enum enMainMenuOptions
        {
            ...
            eFindClient = 5, eTransactions = 6, eManageUsers = 7, eLoginRegister=8, eExit = 9
        }

        private static short _ReadMainMenuOption()
        {

            Console.Write("".PadLeft(35) + "Choose what do you want to do? [1 to 9]? ");
        ...
        */
        ...
        public static void ShowMainMenu()
        {
            ...
            Console.WriteLine("".PadLeft(35) + "\t[9] Logout.");
